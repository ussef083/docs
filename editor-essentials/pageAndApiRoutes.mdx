...
# Pages & API Routes: The Application Blueprint
...
Now that you know how to build the foundational structure of your app, it's time to add content and design your pages.

- **[Adding & Managing Elements →](/editor-essentials/adding-elements)**
