...
<AccordionGroup>
<Accordion title="Navigation Actions" icon="map-signs">
  ...
  <Card title="Go to page..." icon="arrow-right">
    ...
    **Key Parameters:**
    ...
    - `URL Parameters` (Optional): Define key-value pairs to send to the destination page.
  </Card>
...
**Purpose:** Sends an email using a pre-configured email template. This is a
secure **Server-side** action.
...
- `Schema`: Select the Form Schema you want to validate against.
...
<Accordion title="API & SDKs" icon="cloud">
  Actions for connecting to external APIs and leveraging powerful, natively integrated AI models. All actions in this category involve secure **Server-side** communication.
